    ...
    <section id="products" className="bg-[#f5f5f5] py-8 md:py-10">
      <div className="container">
        ...
        <div className="grid gap-6 lg:grid-cols-[220px_1fr]">
          ...
          <div>
            <div className="mb-5 rounded-2xl border border-[#e5e7eb] bg-white p-3 shadow-sm">
              <div className="flex items-center gap-3 rounded-xl border-2 border-[#e5e7eb] bg-[#fafafa] px-3 py-2 transition focus-within:border-[#f97316] focus-within:bg-white">
                <Search className="h-5 w-5 shrink-0 text-[#f97316]" />
                <input
                  value={searchQuery}
                  onChange={event => onSearch(event.target.value)}
                  placeholder="ابحث باسم المنتج أو الوصف..."
                  className="min-w-0 flex-1 bg-transparent text-right text-sm text-[#333] outline-none"
                  style={{ fontFamily: "'Cairo', sans-serif" }}
